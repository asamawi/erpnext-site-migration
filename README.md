...
## Usage:
- **Syntax:** `./migration_script.sh <old_site_name> [<new_site_name>] [--skip-backup] [--skip-copy] [--extract-only] [--skip-preparation] [--skip-restore]`
...
- Use the `--skip-restore` option to skip the database restore step.
